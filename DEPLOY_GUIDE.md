...
2. Clique **"New Query"**
3. Abra o arquivo `estrutura_barbearia.sql` do projeto
...
O projeto inclui um script de setup em `setup-barbearia.js` que automatiza grande parte do processo.
...
| **Foto do barbeiro** | `/public/assets/tato.webp` | Substituir o arquivo (ou fazer upload pelo painel) |
