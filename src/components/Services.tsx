            ...
            <div className="space-y-0" role="list" aria-label="Lista de serviços">
              {services.map((service) => (
                <div
                  ...
                  className="group py-6 md:py-12 flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-white/[0.03] cursor-pointer hover:border-[#D4AF37]/30 transition-all duration-700 gap-1 sm:gap-0"
                ...
                {plans.map((plan, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full py-3.5 bg-[#D4AF37] text-black font-bold text-[11px] uppercase tracking-[0.1em] rounded-xl hover:bg-[#b8962e] transition-all cursor-pointer active:scale-[0.98]"
                    >
                      Tenho interesse
                    </button>
                  </div>
              ...
              >
                ...
                <div className="px-5 py-4 border-b border-white/[0.06] flex items-center justify-between">
                  ...
                  <button
                    ...
                    aria-label="Fechar"
                  >
                    <X size={16} className="text-zinc-400" aria-hidden="true" />
                  </button>
                </div>
