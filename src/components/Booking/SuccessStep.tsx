    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-center max-w-lg mx-auto relative">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            onClick={() => navigate('/')}
            className="px-8 py-3.5 bg-[#D4AF37] text-black rounded-xl text-[11px] font-bold uppercase tracking-wider hover:bg-[#b8962e] active:scale-95 transition-all cursor-pointer"
          >
            Voltar ao início
          </button>
          <button
