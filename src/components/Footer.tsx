...
const Footer: FC = () => {
  ...
  // Ignore placeholder phone numbers (all zeros or default)
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              {barberInstagram ? (
                ...
                <div className="flex items-center gap-3 md:gap-4 text-zinc-600">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-[#141414] border border-white/5 flex items-center justify-center">
                    <InstagramIcon />
                  </div>
                  <span className="font-roboto font-light text-xs md:text-sm">
                    Instagram em breve
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="flex items-start gap-3 md:gap-4 text-zinc-400">
              <div className="shrink-0 mt-1">
                <svg
                  viewBox="0 0 24 24"
                  className="w-3.5 h-3.5 md:w-4 md:h-4 fill-[#D4AF37]"
                  aria-hidden="true"
                  focusable="false"
                >
