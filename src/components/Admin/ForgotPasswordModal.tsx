              ...
              <>
                ...
                <div className="p-6 sm:p-8 space-y-3 sm:space-y-4">
                  <input
                    ...
                    maxLength={120}
                    className="w-full h-11 sm:h-12 bg-transparent border border-white/[0.08] rounded-xl px-4 text-sm text-white outline-none focus:border-[#D4AF37]/50 focus:ring-1 focus:ring-[#D4AF37]/20 transition-colors placeholder:text-zinc-600"
                    placeholder="Insira seu email"
                  />
                  <button
                    onClick={onResetPassword}
                    disabled={isSendingReset || !recoveryEmail.trim()}
                    className="w-full h-11 bg-[#D4AF37] hover:bg-[#b8923f] text-black font-semibold text-sm rounded-xl transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                  >
