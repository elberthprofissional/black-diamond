...
const ProfileDesktopMetrics: React.FC<ProfileDesktopMetricsProps> = ({
  greeting, barberName, barberPhoto, lucroTotal, lucroSemana, lucroMes,
  currentConcluidos, currentCancelados, onLogout,
}) => {
  return (
    <div className="hidden lg:flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4 py-2 border-b border-white/5 pb-5">
        <div className="flex items-center gap-4">
          ...
          <button onClick={onLogout} aria-label="Sair da conta"
