    ...
    <div className="lg:hidden w-full max-w-md mx-auto space-y-6">
      ...
      <div className="px-5 py-1 space-y-1">
        ...
        <div className="text-2xl font-bold text-white tracking-tight leading-none flex items-baseline">
          {showBalance ? (
            <>
              <span className="text-[#D4AF37] font-bold text-sm mr-1">R$</span>
              <span>
                  ...
                  return (
                    <div key={idx} className="space-y-1">
                      ...
                      <div className="h-1.5 bg-white/[0.03] rounded-full overflow-hidden">
                        <div
                          className="h-full bg-[#D4AF37] rounded-full transition-all duration-500 shadow-[0_0_8px_rgba(197,160,89,0.3)]"
