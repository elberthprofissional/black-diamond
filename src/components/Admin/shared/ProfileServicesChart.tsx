              ...
              <div className="flex items-center gap-3">
                <div
                  className={`w-7 h-7 rounded-lg flex items-center justify-center shrink-0 ${
                    isFirst ? 'bg-[#D4AF37]/20 text-[#D4AF37]' : 'bg-white/[0.04] text-zinc-500'
                  }`}
                >
                  <span
                    ...
                    <div className="flex items-center gap-2 ml-2">
                      <span
                        className={`text-[10px] font-black tabular-nums ${
                          isFirst ? 'text-[#D4AF37]' : 'text-zinc-400'
                        }`}
                      >
                        {srv.count}x
                      </span>
              ...
              <div className="h-1.5 bg-white/[0.04] rounded-full overflow-hidden ml-10">
                <div
                  className={`h-full rounded-full transition-all duration-700 ${
                    isFirst
                      ? 'bg-gradient-to-r from-[#D4AF37] to-[#D4B06A] shadow-[0_0_8px_rgba(197,160,89,0.25)]'
                      : 'bg-white/[0.12]'
                  }`}
