...
const ThankYouModal: React.FC<ThankYouModalProps> = ({ booking, onConfirm, onCancel }) => {
            ...
            <div className="p-6 text-center space-y-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-zinc-400 leading-relaxed">
                  Deseja enviar um agradecimento para{' '}
                  <span className="text-[#C5A059] font-semibold">{firstName}</span>{' '}
                  com o link de avaliação?
                </p>
              </div>
              ...
              <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-3 text-left">
                ...
                <p className="text-[11px] text-zinc-300 leading-relaxed italic">
                  "Oi {firstName}, obrigado por cortar com a gente! Deixa sua avaliação aqui: [link]"
                </p>
              </div>
            </div>
