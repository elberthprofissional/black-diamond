...
const DashboardHeader: React.FC<DashboardHeaderProps> = ({ nextBooking, dailyRevenue, onSelectNext }) => {
  return (
    <>
      ...
      <div className="grid grid-cols-[1fr_auto] gap-3 items-end">
        <button onClick={onSelectNext} className="bg-[#111111] border border-white/5 py-3 px-4 rounded-2xl flex items-center gap-3 min-w-0 group hover:border-[#C5A059]/20 hover:bg-white/[0.01] transition-all cursor-pointer">
