    ...
    <div className="flex-1 overflow-y-auto px-6 py-4 min-h-0 scrollbar-hide">
      <div className="relative mb-4">
        ...
        <input
          ...
          className="w-full bg-white/[0.03] border border-white/[0.06] rounded-xl py-3 pl-11 pr-4 text-[14px] text-white outline-none transition-all placeholder:text-zinc-600 focus:border-gold/50 focus:bg-white/[0.05]"
        />
      </div>
      {filtered.length > 0 ? (
