        ...
        >
          <div className="px-5 pt-5 pb-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={onCancel} className="w-6 h-6 rounded-full bg-white/[0.04] flex items-center justify-center text-zinc-600 hover:text-white transition-all cursor-pointer">
                <X size={11} />
              </button>
            </div>
