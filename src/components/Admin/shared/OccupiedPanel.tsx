...
const OccupiedPanel: React.FC<OccupiedPanelProps> = ({ bookings, selectedId, onSelect, onComplete }) => {
  if (bookings.length === 0) {
    return <p className="text-zinc-600 text-[10px] uppercase tracking-widest text-center py-8">Nenhum agendamento</p>;
  }
...
export default React.memo(OccupiedPanel);
