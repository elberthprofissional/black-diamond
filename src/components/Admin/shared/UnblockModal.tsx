...
const UnblockModal: React.FC<UnblockModalProps> = ({ booking, onConfirm, onCancel }) => {
      ...
      <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
        ...
        >
          <div className="p-6 text-center">
            <p className="text-[11px] font-bold text-white uppercase tracking-wider">Desbloquear horário?</p>
            <div className="mt-4 inline-flex items-baseline gap-2">
              <span className="text-3xl font-black text-white tabular-nums">{booking.booking_time.slice(0, 5)}</span>
            </div>
