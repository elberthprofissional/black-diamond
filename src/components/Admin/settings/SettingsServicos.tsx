            ...
            {services.map((service) => (
              ...
              >
                <div className="flex items-baseline gap-4">
                  ...
                  <span className="text-[13px] text-[#C5A059] font-medium">R$ {service.price}</span>
                </div>
        ...
        <div className="border border-white/[0.04] rounded-2xl overflow-hidden">
          <div className="px-5 py-3 bg-white/[0.02] flex items-center justify-between">
            ...
            <button
              onClick={openAdd}
              disabled={services.length >= MAX_SERVICES}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-[#C5A059]/20 text-[#C5A059] text-[11px] font-medium rounded-lg transition-all cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed"
            >
              <Plus size={12} />
              Adicionar
            </button>
          ...
          >
            ...
            >
              <div className="px-6 pt-6 pb-4 text-center">
                ...
                <p className="text-[15px] font-semibold text-white">Excluir serviço?</p>
