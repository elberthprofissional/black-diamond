          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3.5 bg-[#C5A059] hover:bg-[#A68233] text-black text-sm font-bold rounded-2xl transition-all cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed"
              >
                Confirmar
              </button>
            </div>
