import { type TouchEvent, type FC } from 'react';
import {
  X,
  ArrowLeft,
  Move,
...
const GalleryPreview: FC<GalleryPreviewProps> = ({
  previewImage,
  previewIndex,
  images,
  onClose,
    ...
    <AnimatePresence>
      {previewImage && (
        ...
        >
              ...
              {previewImage.created_at && (
                <div className="flex flex-col">
                  <span className="text-zinc-300 text-xs">
                    {new Date(previewImage.created_at).toLocaleDateString('pt-BR', {
                      day: 'numeric',
                      month: 'long',
                      year: 'numeric',
                    })}
                  ...
                  <span className="text-zinc-500 text-[10px]">
                    {new Date(previewImage.created_at).toLocaleTimeString('pt-BR', {
                      hour: '2-digit',
                      minute: '2-digit',
                    })}
                  </span>
          ...
          <div
            className="sm:hidden shrink-0 border-t border-white/10 p-4"
            onClick={(e) => e.stopPropagation()}
          >
