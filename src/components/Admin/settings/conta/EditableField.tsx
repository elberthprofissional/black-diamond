...
interface EditableFieldProps {
  ...
  renderMobileInput: (ref: React.RefObject<HTMLInputElement | HTMLTextAreaElement | null>) => ReactNode;
...
const EditableField: FC<EditableFieldProps> = ({
  label, value, displayValue, placeholder, renderInput, renderMobileInput, mobileHelper,
  onSave, onCancel, canSave, isEditing, setIsEditing, MobileEditScreen: MobileScreen,
}) => {
  ...
  return (
    <>
          ...
          {isEditing ? (
            <div className="p-5 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-[8px] font-bold text-zinc-500 uppercase tracking-[0.2em]">{label}</span>
            ...
            >
              <div className="text-left">
                <span className="text-[8px] font-bold text-zinc-500 uppercase tracking-[0.2em] block mb-1">{label}</span>
      ...
      <MobileScreen isOpen={isEditing} onClose={onCancel} onSave={onSave} title={label} canSave={canSave}>
