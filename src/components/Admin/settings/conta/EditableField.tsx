            ...
            <div className="p-5 space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={onSave}
                  disabled={!canSave}
                  className="px-5 py-3 bg-[#D4AF37] hover:bg-[#b8962e] text-black font-bold text-[10px] uppercase tracking-[0.15em] rounded-xl transition-all cursor-pointer disabled:opacity-25 disabled:cursor-not-allowed"
                >
                  OK
                </button>
              </div>
