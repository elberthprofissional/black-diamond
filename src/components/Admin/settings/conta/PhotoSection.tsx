  ...
  return (
    <div className="relative flex flex-col items-center pt-2 pb-4">
      <button
        ...
        disabled={uploading}
        className="relative w-24 h-24 rounded-full group cursor-pointer overflow-hidden border-2 border-white/10 hover:border-[#D4AF37]/40 transition-all bg-white/[0.03] flex items-center justify-center"
