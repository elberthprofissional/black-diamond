  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto lg:mx-0">
      ...
      {enabled && (
        <>
          {/* How it works banner */}
          <div className="bg-[#C5A059]/[0.04] border border-[#C5A059]/10 rounded-xl p-4 flex items-start gap-3">
          ...
          {/* Add milestone form */}
          {showNewForm ? (
            <div className="bg-[#111111] border border-[#C5A059]/20 rounded-xl p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    placeholder="Ex: 10"
                    className="w-full bg-white/[0.03] border border-white/[0.08] rounded-xl px-4 py-3 text-[14px] text-white font-bold outline-none focus:border-[#C5A059]/50 transition-all placeholder:text-zinc-600"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full bg-white/[0.03] border border-white/[0.08] rounded-xl px-4 py-3 text-[13px] text-white outline-none focus:border-[#C5A059]/40 transition-all appearance-none cursor-pointer"
                    >
              ...
              <button
                ...
                className="w-full h-10 bg-[#C5A059] text-black font-bold text-[11px] uppercase tracking-wider rounded-xl hover:bg-[#A68233] transition-all cursor-pointer flex items-center justify-center gap-1.5"
              >
            ...
            <button
              ...
              className="w-full h-10 border border-dashed border-white/[0.12] text-zinc-400 hover:text-white hover:border-[#C5A059]/30 rounded-xl transition-all cursor-pointer flex items-center justify-center gap-1.5 text-[11px] font-bold"
            >
              <Plus size={14} />
              Adicionar Meta
            </button>
          ...
          {milestones.length > 0 && (
            <button
              ...
              disabled={saving}
              className="w-full h-12 bg-[#C5A059] text-black font-black text-[11px] uppercase tracking-[0.2em] rounded-xl hover:bg-[#A68233] transition-all cursor-pointer disabled:opacity-40 flex items-center justify-center gap-2 shadow-lg shadow-[#C5A059]/10"
            >
              {saving ? (
                <>
