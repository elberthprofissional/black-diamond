...
import { AlertTriangle, Trash2, RotateCcw, Lock } from 'lucide-react';
...
const SettingsDados: FC<SettingsDadosProps> = () => {
                ...
                <>
                  <div className="px-6 pt-6 pb-4">
                    ...
                    <p className="text-[12px] text-zinc-500 mt-1.5 text-center leading-relaxed">
                      Digite sua senha de administrador para{' '}
                      {activeModal === 'bookings'
                        ? 'resetar o financeiro'
