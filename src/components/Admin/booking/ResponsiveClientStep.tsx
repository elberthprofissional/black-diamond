      ...
      <div className="space-y-6 h-full flex flex-col">
        ...
        {onNextStep && isStepValid && (
          <button
            ...
            className="w-full py-4 bg-[#C5A059] text-black text-[13px] font-bold uppercase tracking-wider rounded-xl hover:bg-[#A68233] transition-all cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg shadow-[#C5A059]/20"
          >
          ...
          <div className="space-y-4">
            ...
            {onOpenSearch && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 text-[11px] font-bold text-[#C5A059] uppercase tracking-wider hover:bg-white/[0.02] rounded-xl transition-all cursor-pointer"
              >
