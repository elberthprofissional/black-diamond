...
const ManageBooking: FC = () => {
      ...
      <div className="min-h-screen bg-[#050505] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            <div className="w-12 h-12 rounded-full border-2 border-[#C5A059]/20 border-t-[#C5A059] animate-spin" />
            <Sparkles
              size={14}
              className="text-[#C5A059] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
            />
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#050505] relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#C5A059]/[0.03] via-transparent to-transparent pointer-events-none" />
        ...
        <div className="max-w-lg mx-auto">
          ...
          >
            ...
            <div>
              ...
              <p className="text-[10px] text-[#C5A059]/60 uppercase tracking-[0.2em] font-medium">
                Black Diamond
              </p>
            </div>
          </motion.div>
          ...
          {activeBookings.length > 0 && (
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-5">
                <div className="h-px flex-1 bg-gradient-to-r from-[#C5A059]/20 to-transparent" />
                <p className="text-[9px] font-bold text-[#C5A059]/50 uppercase tracking-[0.25em]">
                  Agendamentos ativos
                </p>
                <div className="h-px flex-1 bg-gradient-to-l from-[#C5A059]/20 to-transparent" />
              </div>
              ...
              {activeBookings.map((booking, index) => (
                ...
                >
                  ...
                  <div className="absolute -inset-px bg-gradient-to-b from-[#C5A059]/10 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                  <div className="relative bg-[#0c0c0c] border border-white/[0.06] rounded-2xl overflow-hidden">
                    {/* Gold accent line */}
                    <div className="h-[2px] bg-gradient-to-r from-transparent via-[#C5A059]/40 to-transparent" />
                    ...
                    <div className="p-5 space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5">
                              <Clock size={10} className="text-[#C5A059]/60" />
                              <p className="text-[12px] font-black text-[#C5A059] tabular-nums">
                      ...
                      <div className="flex items-center justify-between pl-[52px]">
                        <div className="flex items-center gap-1.5">
                          <DollarSign size={13} className="text-[#C5A059]/60" />
                      ...
                      <div className="flex items-center gap-2.5 pl-[52px]">
                        <button
                          ...
                          className="flex-1 h-11 rounded-xl bg-gradient-to-r from-[#C5A059] to-[#b8944d] text-black font-bold text-[10px] uppercase tracking-[0.15em] hover:from-[#d4b06a] hover:to-[#C5A059] active:scale-[0.98] transition-all cursor-pointer flex items-center justify-center gap-2 shadow-lg shadow-[#C5A059]/20"
                        >
                          Reagendar
