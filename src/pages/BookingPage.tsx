              ...
              {step === 1 && (
                ...
                >
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <h3 className="text-xl font-serif font-bold uppercase tracking-widest text-white italic">Escolha os Serviços</h3>
                  </div>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {services.map((service) => (
                        <button
                          ...
                          className={`flex justify-between items-center p-6 border transition-all duration-500 text-left rounded-xl ${
                        ...
                        >
                          <div>
                            <div className="font-serif font-bold text-lg text-white mb-1 uppercase tracking-tight">{service.name}</div>
                ...
                >
                  <div className="space-y-8">
                    <div className="flex items-center space-x-4">
                      ...
                      <h3 className="text-xl font-serif font-bold uppercase tracking-widest text-white italic">Escolha a Data</h3>
                    </div>
                    <input 
                      type="date" 
                      className="w-full bg-black/20 border border-white/5 text-white p-5 rounded-xl outline-none focus:border-gold-600 transition-colors uppercase text-[11px] font-bold tracking-[0.2em]"
                      value={selectedDate}
              ...
              {step === 3 && (
                ...
                >
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <h3 className="text-xl font-serif font-bold uppercase tracking-widest text-white italic">Seus Dados</h3>
                  </div>
                  
                  <div className="space-y-6">
                    <div className="group relative">
                      <label className="text-[9px] font-black uppercase tracking-[0.3em] text-gray-500 mb-2 block group-focus-within:text-gold-600 transition-colors ml-1">Nome Completo</label>
                      <input 
                        type="text" 
                        placeholder="Ex: João Silva"
                        className="w-full bg-black/20 border border-white/5 text-white p-5 rounded-xl outline-none focus:border-gold-600 transition-colors text-sm font-medium tracking-wide"
                        value={userInfo.name}
                        onChange={(e) => setUserInfo({...userInfo, name: e.target.value})}
                      />
                    </div>
                    <div className="group relative">
                      <label className="text-[9px] font-black uppercase tracking-[0.3em] text-gray-500 mb-2 block group-focus-within:text-gold-600 transition-colors ml-1">WhatsApp</label>
                      <input 
                        type="tel" 
              ...
              {step === 4 && (
                ...
                >
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <h3 className="text-3xl font-serif font-bold text-white uppercase tracking-widest italic">Resumo Final</h3>
                  </div>
                  ...
                  <div className="bg-black/20 p-10 border border-white/5 text-left space-y-6 max-w-lg mx-auto rounded-2xl">
                    ...
                    <div className="flex justify-between items-baseline pt-4">
                      ...
                      <span className="text-3xl font-serif font-bold text-gold-600 tracking-tighter">R$ {totalPrice.toFixed(2)}</span>
                    </div>
                  </div>
                  
                  <p className="text-gray-600 text-[10px] font-bold uppercase tracking-[0.2em] max-w-sm mx-auto leading-relaxed">
                    Clique abaixo para confirmar sua reserva na Black Diamond.
                  </p>
                </motion.div>
              )}
            ...
            <div className="flex justify-between items-center mt-12 pt-8 border-t border-white/5">
              ...
              {step < 4 ? (
                <button 
                  ...
                  onClick={() => setStep(step + 1)}
                  className="bg-transparent border border-gold-600 text-gold-600 hover:bg-gold-600 hover:text-black font-black px-12 py-4 text-[10px] uppercase tracking-[0.4em] transition-all disabled:opacity-30 rounded-lg"
                >
                ...
                <button 
                  ...
                  className="bg-gold-600 text-black font-black px-16 py-5 text-[10px] uppercase tracking-[0.5em] hover:bg-[#F5E0A3] transition-all duration-500 shadow-[0_0_30px_rgba(212,175,55,0.2)] disabled:opacity-50 rounded-xl"
                >
