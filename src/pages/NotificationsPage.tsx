    ...
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col">
            ...
            <>
              ...
              {displayed.length > 0 && (
                <button
                  ...
                  className="text-[10px] font-bold text-[#C5A059] hover:text-[#d4b06a] transition-colors cursor-pointer"
                >
      ...
      <AnimatePresence>
        {selectionMode && selectedIds.size > 0 && (
          ...
          >
            <div className="px-4 py-2.5 bg-[#C5A059]/[0.04] border-b border-[#C5A059]/10 flex items-center justify-between">
