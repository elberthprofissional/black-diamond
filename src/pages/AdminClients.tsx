              ...
              {filteredClients.map((client) => {
                ...
                return (
                  <div
                    ...
                    className={`w-full p-5 rounded-2xl border transition-all duration-200 cursor-pointer group text-left ${needsReminder ? 'bg-white/[0.03] border-white/[0.06] hover:bg-white/[0.05] hover:border-[#C5A059]/20' : 'bg-white/[0.02] border-white/[0.05] hover:bg-white/[0.04] hover:border-white/[0.1]'}`}
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        <div className="relative shrink-0">
                          <div className="w-11 h-11 rounded-xl bg-[#111111] border border-white/[0.08] group-hover:border-[#C5A059]/30 flex items-center justify-center text-sm font-bold text-white uppercase transition-colors">
                            {client.name.charAt(0)}
                          </div>
                          {client.is_mensalista ? (
                            <div
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        {needsReminder ? (
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-[10px] font-semibold transition-all active:scale-95 cursor-pointer bg-[#C5A059]/10 hover:bg-[#C5A059]/20 text-[#C5A059]"
                          >
