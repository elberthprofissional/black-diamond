                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3.5 min-w-0">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            {client.isInactive && (
                              <span className="text-[8px] px-1.5 py-0.5 rounded bg-amber-500/10 text-amber-400 font-bold uppercase shrink-0">
                                Inativo
                              </span>
                            )}
                          </div>
                      ...
                      {needsReminder ? (
                        <button
                          ...
                          className="shrink-0 flex items-center gap-1.5 px-3 py-2 rounded-xl text-[10px] font-semibold transition-all active:scale-95 cursor-pointer bg-[#C5A059]/10 hover:bg-[#C5A059]/20 text-[#C5A059]"
                        >
                    ...
                    <div className="ml-[60px] space-y-1.5">
                      <p className="text-[12px] text-zinc-400">{formatPhone(client.phone)}</p>
