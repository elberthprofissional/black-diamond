            ...
            >
              ...
              <div className="px-5 py-5 space-y-5">
                ...
                <div className="space-y-2">
                  <button onClick={() => setIsReminderOpen(true)} className="w-full h-10 bg-[#C5A059] hover:bg-[#A68233] text-black text-[10px] font-bold uppercase tracking-[0.1em] rounded-xl transition-all cursor-pointer">
                    Enviar Lembrete
                  </button>
                  <a href={`https://wa.me/55${selectedClient.phone?.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="w-full h-10 bg-white/[0.04] border border-white/[0.06] hover:bg-white/[0.06] text-white text-[10px] font-bold uppercase tracking-[0.1em] rounded-xl transition-all cursor-pointer flex items-center justify-center gap-1.5">
                    Enviar Mensagem
                  </a>
                </div>
